    ...
    for (const [wire, expectedStage] of [
      ...
      ...[
        ...
        [{ inputs_present: true, inputs: [{ key: 'CANARY_SECRET', type: 'string',
          ...
          description_present: false, description: null }] }, 'output_wire_dsl_input_key'],
        [{ inputs_present: true, inputs: [{ key: 'safe_key', type: 'string',
          required: true, default_present: true, default_value: { kind: 'string', string_value: 'CANARY_SECRET' },
          description_present: false, description: null }] }, 'output_wire_dsl_input_required_default'],
        [{ inputs_present: true, inputs: [{ key: 'safe_key', type: 'number',
          required: false, default_present: true, default_value: { kind: 'string', string_value: 'CANARY_SECRET' },
          description_present: false, description: null }] }, 'output_wire_dsl_input_default_type'],
        [{ inputs_present: true, inputs: [{ key: 'safe_key', type: 'string',
          required: false, default_present: false, default_value: null,
          description_present: true, description: 'CANARY_SECRET'.repeat(30) }] }, 'output_wire_dsl_input_field'],
