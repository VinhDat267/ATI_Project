...
- Có DB package với runner 6 SQL migrations (qua `0006_http_trace_snapshots.sql`), Drizzle và seed thêm dữ liệu thiếu với `ON CONFLICT DO NOTHING`, không reset dữ liệu.
...
- AI-00 đang ở trạng thái **IN_PROGRESS**: đã chốt draft seam/design cho provider, retrieval, query expansion, bounded repair, local replan và evaluation; live model, embedding runtime và AI evaluation vẫn `NOT_RUN`. Xem [AI status](docs/AI-STATUS-2026-09-17.md), [AI design](docs/superpowers/specs/2026-09-17-ai-backend-design.md) và [AI plan](docs/superpowers/plans/2026-09-17-ai-backend.md).
