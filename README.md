...
| AI quality v2 | [Chiến dịch public](docs/ai-evidence/PILOT-V2-AI/PROBE-2026-09-26.md) Gemini 3.1 Flash-Lite có 26/26 observation, 25/26 structural PASS; [scope model-only](docs/ai-evidence/PILOT-V2-AI/MODEL-SCOPE-2026-09-26.md) dùng 26 public + 20 holdout mới | `PARTIAL_NOT_MEASURED`: V2-10-en đề xuất một write khi cần hỏi rõ người nhận; holdout 20/20 chưa chạy, chưa adjudicate nội dung độc lập; 14 ca quyền/execution thuộc nghiệm thu hệ thống |
