...
const result = { checked_at:new Date().toISOString(), node:process.version,
  ...
  limitations:['JSON Schema structural checks do not replace Zod refinements or runtime authorization','PostgreSQL migration, HTTP, live MCP, LLM and browser E2E NOT_RUN'], failures };
