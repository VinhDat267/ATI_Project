...
- P3 backup/restore evidence `NOT_RUN`: repository hiện có migration/seed và isolated test fixtures nhưng không có command/script backup–restore production; RPO/RTO, restore rehearsal và accounting/schema verification sau restore vẫn `OPEN`.
