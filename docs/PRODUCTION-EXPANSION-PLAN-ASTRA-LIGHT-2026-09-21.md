...
- The visual Design System was approved by the project owner and committed as
  `e57a5ad`; representative-user UX acceptance remains open.
...
- AI quality, production operations, restore/incident evidence, and
...
| **P6 Design/acceptance** | Apply the approved [System Design](../System%20Design/DESIGN.md) to identity/callback/expiry/approval/cancel/uncertainty UX; prepare the representative-user script. | Accessibility/browser evidence plus separate user acceptance for correctness, approval comprehension and failure recovery. |
