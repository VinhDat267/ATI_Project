...
fs.writeFileSync(path.join(outDir,'helper-under-review.mjs'),compiled);
const {inspectFilesystemPath,readBoundedUtf8} = await import(new URL('./helper-under-review.mjs',import.meta.url).href);
