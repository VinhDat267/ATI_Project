...
- Runner BE-27 chưa có production caller hoặc approval store được nối vào; replay `confirmed` hiện không trả đủ receipt chuẩn. Các nhánh API, browser, SaaS và AI provider vẫn cần evidence riêng. `HANDOFF_BLOCKED` giữ nguyên.
