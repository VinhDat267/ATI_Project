...
| AI | Source snapshot có trước planning, checklist và bằng chứng; giữ semantic/QE/replan có giới hạn | Module source-aware có; chưa nối đầy đủ vào API pilot. Gemini 3.1 Flash-Lite đạt 25/26 structural PASS trên public; một ca FAIL an toàn phân công, holdout chưa chạy; `PARTIAL_NOT_MEASURED` |
