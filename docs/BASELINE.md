...
| AI | Source snapshot có trước planning, checklist và bằng chứng; giữ semantic/QE/replan có giới hạn | Module source-aware có; chưa nối đầy đủ vào API pilot. Freeze `d35a9af` đạt 26/26 structural PASS trên public sau sửa input key và required/default; review nội dung public còn findings, holdout chưa chạy, `PARTIAL_NOT_MEASURED`. Xem [public evidence](ai-evidence/PILOT-V2-AI/PUBLIC-2026-09-26.md) |
